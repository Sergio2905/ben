...
document.addEventListener('click', (e) => {
    const upBtn = e.target.closest('.btn_up');
    if (upBtn) {
        scrollToTop();
    }
});
...
const partners = new swiper__WEBPACK_IMPORTED_MODULE_5__["default"]('.partners__slider', {
    observer: true,
    observeParents: true,
...
const start = new swiper__WEBPACK_IMPORTED_MODULE_5__["default"]('.start__slider', {
    observer: true,
    observeParents: true,
    observeSlideChildren: true,
    slidesPerView: 1.5,
